    ...
    public void testPoorlyFormattedLine() {
        ...
        try {
            ...
            assertEquals("""
                ...
                Line #3 (6D 7H 8S 9C TD-KH) failed with exception: java.lang.IllegalArgumentException: Invalid card length, expected 2 characters but was 5\r
    ...
    public void testFileWithBothSuccessfulLinesAndErrorLines() {
        ...
        try {
            ...
            assertEquals("""
                ...
                Line #4 (4H KS 2C TH 5X2D) failed with exception: java.lang.IllegalArgumentException: Invalid card length, expected 2 characters but was 4\r
